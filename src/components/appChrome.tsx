...
function IconGoodsEntryNav() {
  return (
    <svg viewBox="0 0 24 24" className="ui-icon ui-icon-solid" aria-hidden="true">
      <path d="M4.86742 9.85751 5.86488 9.92875 4.86742 9.85751ZM4.15313 19.8575 5.15059 19.9288 4.15313 19.8575ZM19.1328 9.8575 18.1353 9.92875 19.1328 9.8575ZM8.0001 10C8.0001 10.5523 8.44781 11 9.0001 11 9.55238 11 10.0001 10.5523 10.0001 10H8.0001ZM14.0001 10C14.0001 10.5523 14.4478 11 15.0001 11 15.5524 11 16.0001 10.5523 16.0001 10H14.0001ZM12 23C12.5523 23 13 22.5523 13 22 13 21.4477 12.5523 21 12 21V23ZM18.3598 13.0712C18.3991 13.6221 18.8776 14.0368 19.4285 13.9975 19.9794 13.9581 20.3941 13.4796 20.3547 12.9288L18.3598 13.0712ZM19.293 22.7071C19.6835 23.0976 20.3167 23.0976 20.7072 22.7071 21.0977 22.3166 21.0977 21.6834 20.7072 21.2929L19.293 22.7071ZM17.1379 7H15.0001V9H17.1379V7ZM15.0001 7H9.0001V9H15.0001V7ZM9.0001 7H6.86234V9H9.0001V7ZM3.86996 9.78626 3.15568 19.7863 5.15059 19.9288 5.86488 9.92875 3.86996 9.78626ZM6.86234 7C5.28842 7 3.9821 8.21634 3.86996 9.78626L5.86488 9.92875C5.90226 9.40545 6.3377 9 6.86234 9V7ZM20.1302 9.78626C20.0181 8.21634 18.7118 7 17.1379 7V9C17.6625 9 18.0979 9.40545 18.1353 9.92875L20.1302 9.78626ZM6.14805 21C5.56771 21 5.10925 20.5076 5.15059 19.9288L3.15568 19.7863C3.03163 21.5229 4.40703 23 6.14805 23V21ZM10.0001 10V8H8.0001V10H10.0001ZM10.0001 8V6H8.0001V8H10.0001ZM14.0001 6V8H16.0001V6H14.0001ZM14.0001 8V10H16.0001V8H14.0001ZM12.0001 4C13.1047 4 14.0001 4.89543 14.0001 6H16.0001C16.0001 3.79086 14.2092 2 12.0001 2V4ZM10.0001 6C10.0001 4.89543 10.8955 4 12.0001 4V2C9.79096 2 8.0001 3.79086 8.0001 6H10.0001ZM6.14805 23H12V21H6.14805V23ZM20.3547 12.9288 20.1302 9.78626 18.1353 9.92875 18.3598 13.0712 20.3547 12.9288ZM17.7648 17.8824C17.7648 18.9219 16.922 19.7647 15.8825 19.7647V21.7647C18.0266 21.7647 19.7648 20.0265 19.7648 17.8824H17.7648ZM15.8825 19.7647C14.8429 19.7647 14.0001 18.9219 14.0001 17.8824H12.0001C12.0001 20.0265 13.7383 21.7647 15.8825 21.7647V19.7647ZM14.0001 17.8824C14.0001 16.8428 14.8429 16 15.8825 16V14C13.7383 14 12.0001 15.7382 12.0001 17.8824H14.0001ZM15.8825 16C16.922 16 17.7648 16.8428 17.7648 17.8824H19.7648C19.7648 15.7382 18.0266 14 15.8825 14V16ZM17.2342 20.6483 19.293 22.7071 20.7072 21.2929 18.6484 19.2341 17.2342 20.6483Z" />
    </svg>
  );
}
...
function IconUsersNav() {
  return (
    <svg viewBox="0 0 24 24" className="ui-icon" aria-hidden="true">
      ...
      <path d="M4.5 18.5c.7-2.7 2.8-4.1 6-4.1s5.3 1.4 6 4.1" />
      <path d="M14.5 18.5c.4-1.8 1.8-2.8 4-2.8 1 0 1.9.2 2.7.7" />
    </svg>
  );
}
