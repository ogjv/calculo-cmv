...
export function useAppPresentation({ currentSection, effectiveSession, t }: UseAppPresentationOptions): AppPresentationModel {
  ...
  const accountPanelCopy = {
    ...
    inviteTitle: String(t("teamInviteTitle")),
    inviteText: String(t("teamInviteText")),
    inviteEmail: String(t("teamInviteEmail")),
    inviteHint: String(t("teamInviteHint")),
    inviteAction: String(t("teamInviteAction")),
    invitePending: String(t("teamInvitePending")),
    inviteEmpty: String(t("teamInviteEmpty")),
    inviteRevoke: String(t("teamInviteRevoke")),
    inviteRestaurants: String(t("authRestaurants")),
    inviteAccessLabel: String(t("teamFeatureDashboard")),
