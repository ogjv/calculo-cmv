...
export function useAppPresentation({ currentSection, effectiveSession, t }: UseAppPresentationOptions): AppPresentationModel {
  ...
  const authScreenCopy = {
    ...
    forgotPassword: String(t("authForgotPassword")),
    forgotPasswordHint: String(t("authForgotPasswordHint")),
    forgotPasswordSent: String(t("authForgotPasswordSent")),
    resetPasswordTitle: String(t("authResetPasswordTitle")),
    resetPasswordText: String(t("authResetPasswordText")),
    newPassword: String(t("authNewPassword")),
