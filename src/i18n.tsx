...
export const translations = {
  pt: {
    ...
    authForgotPasswordHint: "Informe seu e-mail e enviaremos um link de recupera\u00e7\u00e3o.",
    authForgotPasswordSent: "Se este e-mail estiver cadastrado, enviaremos um link de recupera\u00e7\u00e3o em instantes.",
    authResetPasswordTitle: "Defina uma nova senha",
    authResetPasswordText: "Digite e confirme sua nova senha para concluir a recupera\u00e7\u00e3o da conta.",
    authNewPassword: "Nova senha",
    authConfirmPassword: "Confirmar nova senha",
    authUpdatePassword: "Atualizar senha",
    authPasswordMismatch: "As senhas informadas n\u00e3o conferem.",
    authPasswordStrengthError: "Use uma senha forte com letra mai\u00fascula, min\u00fascula, n\u00famero e caractere especial.",
    authPasswordStrengthHint: "M\u00ednimo recomendado: 8 caracteres, com mai\u00fascula, min\u00fascula, n\u00famero e caractere especial.",
    authPasswordUpdated: "Senha atualizada com sucesso.",
    ...
    navGoodsEntry: "Entrada de mercadorias",
    navRestaurants: "Restaurantes",
    navTeam: "Gerenciamento de usuários",
    goodsEntryTitle: "Análise de entrada de mercadorias",
    goodsEntryText: "Área reservada para analisar compras, recebimentos e consistência das entradas da operação.",
    ...
    authRestaurantNavigator: "Restaurantes",
  ...
  es: {
    ...
    authForgotPasswordHint: "Informa tu correo y enviaremos un enlace de recuperaci\u00f3n.",
    authForgotPasswordSent: "Si este correo est\u00e1 registrado, enviaremos un enlace de recuperaci\u00f3n en instantes.",
    authResetPasswordTitle: "Define una nueva contrase\u00f1a",
    authResetPasswordText: "Escribe y confirma tu nueva contrase\u00f1a para concluir la recuperaci\u00f3n de la cuenta.",
    authNewPassword: "Nueva contrase\u00f1a",
    authConfirmPassword: "Confirmar nueva contrase\u00f1a",
    authUpdatePassword: "Actualizar contrase\u00f1a",
    authPasswordMismatch: "Las contrase\u00f1as no coinciden.",
    authPasswordStrengthError: "Usa una contrase\u00f1a fuerte con may\u00fascula, min\u00fascula, n\u00famero y car\u00e1cter especial.",
    authPasswordStrengthHint: "M\u00ednimo recomendado: 8 caracteres, con may\u00fascula, min\u00fascula, n\u00famero y car\u00e1cter especial.",
    authPasswordUpdated: "Contrase\u00f1a actualizada con \u00e9xito.",
    ...
    navGoodsEntry: "Entrada de mercaderías",
    navRestaurants: "Restaurantes",
    navTeam: "Gestión de usuarios",
    goodsEntryTitle: "Análisis de entrada de mercaderías",
    goodsEntryText: "Área reservada para analizar compras, recepciones y consistencia de las entradas de la operación.",
  ...
  en: {
    ...
    authForgotPasswordHint: "Enter your email and we will send a recovery link.",
    authForgotPasswordSent: "If this email is registered, we will send a recovery link shortly.",
    authResetPasswordTitle: "Set a new password",
    authResetPasswordText: "Enter and confirm your new password to finish recovering your account.",
    ...
    authPasswordStrengthError: "Use a strong password with uppercase, lowercase, number and special character.",
    authPasswordStrengthHint: "Recommended minimum: 8 characters, with uppercase, lowercase, number and special character.",
    ...
    navDashboard: "Dashboard",
    navDre: "P&L analysis",
    navGoodsEntry: "Goods intake",
    navRestaurants: "Restaurants",
    navTeam: "User management",
    goodsEntryTitle: "Goods intake analysis",
    goodsEntryText: "Reserved area to analyze purchases, receiving flow and consistency of operational stock entries.",
    ...
    authRestaurantNavigator: "Restaurants",
