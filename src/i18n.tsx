...
export const translations = {
  pt: {
    ...
    ownerInviteTitle: "Convidar pessoa",
    ownerInviteText: "Defina o acesso da pessoa por e-mail e vincule os restaurantes liberados para ela.",
    ownerInviteEmail: "E-mail da pessoa",
    ownerInviteFeatures: "Funcionalidades liberadas",
    ownerInviteAccessLabel: "Dashboard de CMV",
    ownerInviteAccountRole: "Papel na conta",
    ownerInviteRestaurantRole: "Papel nos restaurantes",
    ownerInviteRestaurants: "Restaurantes liberados",
    ownerInviteAction: "Enviar convite",
    ownerInvitePending: "Convites pendentes",
    ownerInviteEmpty: "Nenhum convite pendente nesta conta.",
    ownerInviteRevoke: "Revogar convite",
    ownerInviteHint: "A pessoa pode criar a própria senha no cadastro. Se já tiver conta, o acesso entra no próximo login.",
  ...
  es: {
    ...
    ownerInviteTitle: "Invitar persona",
    ownerInviteText: "Define el acceso por correo y vincula los restaurantes permitidos para esa persona.",
    ownerInviteEmail: "Correo de la persona",
    ...
    ownerInviteRestaurants: "Restaurantes habilitados",
    ownerInviteAction: "Enviar invitación",
    ownerInvitePending: "Invitaciones pendientes",
    ownerInviteEmpty: "No hay invitaciones pendientes en esta cuenta.",
    ownerInviteRevoke: "Revocar invitación",
    ownerInviteHint: "La persona puede crear su propia contraseña al registrarse. Si ya tiene cuenta, el acceso se aplicará en el próximo ingreso.",
  ...
  en: {
    ...
    ownerInviteTitle: "Invite person",
    ownerInviteText: "Define access by email and link the restaurants that person can use.",
    ownerInviteEmail: "Person email",
    ownerInviteFeatures: "Enabled features",
    ownerInviteAccessLabel: "CMV Dashboard",
    ownerInviteAccountRole: "Account role",
    ownerInviteRestaurantRole: "Restaurant role",
    ownerInviteRestaurants: "Allowed restaurants",
    ownerInviteAction: "Send invite",
    ownerInvitePending: "Pending invites",
    ownerInviteEmpty: "There are no pending invites in this account.",
    ownerInviteRevoke: "Revoke invite",
    ownerInviteHint: "The person can create their own password when signing up. If they already have an account, access will be applied on the next login.",
